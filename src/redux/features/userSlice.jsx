...
export const docreview = createAsyncThunk(
  'auth/docreview',
  async ({ formValue, history }) => {
    try {
...
export const hosdoc = createAsyncThunk(
  'auth/hosdoc',
  async ({ formValue, history }) => {
    try {
...
export const hosreview = createAsyncThunk(
  'auth/hosreview',
  async ({ formValue, history }) => {
    try {
...
export const bookappointment = createAsyncThunk(
  ...
  async ({ formValue, history }) => {
    try {
      ...
      history.push('/')
      toast.success(
        'Appointment Booked! Check your mail for further details ✅'
      )
      return res.data
    } catch (error) {
      console.log(error)
