  ...
  return (
    <>
      ...
      <div className='about'>
        ...
        <a
          href='https://www.google.com/maps/place/Swaroop+Rani+Nehru+Hospital/@25.4461738,81.8420723,17z/data=!4m6!3m5!1s0x399acab7d1b7e431:0xe418877386cc0ecc!8m2!3d25.4461738!4d81.8442664!16s%2Fg%2F1tdhcf4p'
          target='_blank'
        >
      ...
      <div className='spec-bed-books'>
        ...
        <div className='vaccant-bed-sec'>
          <div className='drpdwn2'>Rooms</div>
          {hospData.map((e) => {
            return (
              <BedCard
                roomcond={e.roomcond}
                type={e.type}
                availablebeds={e.availablebeds}
              />
            )
          })}
        </div>
