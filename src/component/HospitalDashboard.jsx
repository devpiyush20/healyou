      ...
      <div className='mn'>
        ...
        <div className='mainn-hd'>
          ...
          <div className='info-h'>
            <img src={hos} alt='Hospital' className='hosimg' />
            <div className='info-txt'>
              <h2>Lorem Lipsum</h2>
              <p>
                <img src={pin} alt='' className='pn' /> Lorem ipsum dolor sit
                amet consectetur adipisicing elit. Cum atque inven
              </p>
              <h5>
          ...
          <div className='abd' id='abd'>
            ...
            />
            <div className='btnnn' onClick={bedSubmit}>
              Add
            </div>
          </div>
          <h4>Beds Status</h4>
          <div className='btn' onClick={addBed}>
            Add Bed type
          </div>
          <div className='bds'>
            {bedData?.map((e) => {
          ...
          <div className='btn' onClick={addDoc}>
            Add Doctor
          </div>
          <div className='abd' id='aad'>
            ...
            <div className='btnnn' onClick={docSubmit}>
              Add
            </div>
          </div>
          <div className='dl'>
